...
=== Principle
This package will not create finalized graph on its own. You'll have to use https://www.yworks.com/products/yed[Yed] or another GUI that support .graphml to render the graph correct. By default, node size is not adapted to its content, and all nodes are on top of eachother.
...
. Open the file in https://www.yworks.com/products/yed[Yed]
